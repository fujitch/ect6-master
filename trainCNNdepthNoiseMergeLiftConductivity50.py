...
for coil in [1, 3, 5, 7]:
    for frequency in [25]:
        ...
        for i in range(dataset_size):
            ...
            for k in range(99):
                if k < 6:
                    ...
                    if random_id == 0:
                        datasetMatrix[i, k] = data1[k] * (random.random() * 0.2 + 0.9)
                    elif random_id == 1:
                        datasetMatrix[i, k] = data3[k] * (random.random() * 0.2 + 0.9)
                    else:
                        datasetMatrix[i, k] = data5[k] * (random.random() * 0.2 + 0.9)
        ...
        pickle.dump(datasetTrain, open("data2/" + fname + "_" + str(coil) + "_0_Train_NoiseRandomLiftConductivityAll.pickle", "wb"))
        pickle.dump(datasetTest, open("data2/" + fname + "_" + str(coil) + "_0_Test_NoiseRandomLiftConductivityAll.pickle", "wb"))
        """
        ...
        saver.save(sess, "./model2/20181202CNNmodeldepthNoiseRandomLift" + fname + "_" + str(coil) + "_byall")
        sess.close()
