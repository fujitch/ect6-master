...
for coil in [1, 3, 5, 7]:
    ...
    for frequency in [25]:
        ...
        try:
            dataset = pickle.load(open("data/" + fname + "_" + str(coil) + "_0_Test_NoiseRandomLiftConductivityAll.pickle", "rb"))
        except:
            continue
        ...
        saver.restore(sess, "./model2/20181202CNNmodeldepthNoiseRandomLift" + fname + "_" + str(coil) + "_byall")
        ...
        plt.savefig("./20181202CNNmodeldepthNoiseMergeLift" + fname + "_" + str(coil) + "_byall.jpg")
        plt.show()
